...
const seedRecipes = [
  ...
  },
  {
    ...
    servings: 4,
    ingredients_json: JSON.stringify([
      { item: 'center-cut salmon fillets', quantity: '4', unit: 'pieces', notes: 'about 6 oz each' },
      { item: 'thick asparagus spears', quantity: '1', unit: 'lb', notes: 'trimmed' },
      { item: 'unsalted butter', quantity: '4', unit: 'tbsp' },
      { item: 'lemon', quantity: '1', unit: 'whole', notes: 'zested and juiced' },
      { item: 'garlic', quantity: '2', unit: 'cloves', notes: 'finely minced' },
    ...
    instructions_json: JSON.stringify([
      'Preheat a grill or grill pan to medium-high heat, about 400°F. Pat the salmon dry so it browns instead of steaming.',
      'Brush the salmon and asparagus with olive oil, then season evenly with the salt and pepper. Place the asparagus crosswise on the grates so it does not fall through.',
      'Grill the salmon for 4 to 5 minutes on the first side, then flip carefully and cook 3 to 4 minutes more until the center is just opaque and the fish flakes easily with a fork.',
      'Grill the asparagus for 5 to 6 minutes, turning once, until bright green with light char marks and tender-crisp tips.',
      'While the salmon cooks, melt the butter in a small saucepan over low heat. Stir in the garlic and cook 30 seconds until fragrant but not browned, then stir in the lemon zest, lemon juice, and dill.',
      'Transfer the salmon and asparagus to plates. Spoon the lemon garlic butter over the top and serve right away while the salmon is still glossy and hot.'
    ]),
  ...
  },
  {
    ...
    servings: 4,
    ingredients_json: JSON.stringify([
      { item: '90% lean ground beef', quantity: '1 1/2', unit: 'lb' },
      { item: 'crunchy taco shells', quantity: '12', unit: 'pieces' },
      { item: 'yellow onion', quantity: '1', unit: 'medium', notes: 'divided, half diced and half finely minced' },
      { item: 'roma tomatoes', quantity: '2', unit: 'medium', notes: 'diced small' },
    ...
    instructions_json: JSON.stringify([
      'Heat a large skillet over medium heat. Add the beef, diced onion, cumin, chili powder, and 1/2 teaspoon salt, then cook 8 to 10 minutes, breaking the meat into small crumbles until browned and no pink remains.',
      'Tilt the skillet and spoon off excess fat if needed so the filling stays savory instead of greasy.',
      'While the beef cooks, combine the tomatoes, minced onion, cilantro, and juice from half the lime in a small bowl. Let the salsa sit for a few minutes so the flavors mingle.',
      'Mash the avocados with the remaining lime juice and 1/2 teaspoon salt until creamy but still a little chunky.',
      'Warm the taco shells according to package directions until crisp and fragrant.',
      'Fill each shell with beef, then top with salsa and guacamole. Serve right away so the shells stay crunchy.'
    ]),
  ...
  },
  {
    ...
    servings: 4,
    ingredients_json: JSON.stringify([
      { item: 'boneless skinless chicken breasts', quantity: '4', unit: 'pieces' },
      { item: 'olive oil', quantity: '3', unit: 'tbsp' },
      ...
      { item: 'baby Yukon Gold potatoes', quantity: '1', unit: 'lb', notes: 'halved' },
      { item: 'carrots', quantity: '2', unit: 'medium', notes: 'cut into 1-inch chunks' },
      { item: 'kosher salt', quantity: '1', unit: 'tsp' },
      { item: 'black pepper', quantity: '1/2', unit: 'tsp' }
    ]),
    instructions_json: JSON.stringify([
      'Preheat the oven to 425°F and line a large sheet pan with parchment for easier cleanup. Pat the chicken dry so it roasts instead of steaming.',
      'Stir together 1 tablespoon olive oil, the lemon juice, garlic, rosemary, thyme, salt, and pepper in a small bowl. Rub the mixture all over the chicken.',
      'Toss the potatoes and carrots with the remaining 2 tablespoons olive oil directly on the sheet pan, then spread them into an even layer so the edges can caramelize.',
      'Nestle the chicken among the vegetables and scatter the lemon slices over the top.',
      'Roast for 25 to 30 minutes, stirring the vegetables once halfway through, until the chicken reaches 165°F in the thickest part and the potatoes are tender when pierced with a fork.',
      'Let the chicken rest 5 minutes before slicing. Serve with the roasted vegetables and any lemony pan juices spooned over the top.'
    ]),
  ...
  },
  {
    ...
    servings: 4,
    ingredients_json: JSON.stringify([
      { item: 'large peeled and deveined shrimp', quantity: '1', unit: 'lb' },
      { item: 'red bell pepper', quantity: '1', unit: 'medium', notes: 'sliced' },
      { item: 'yellow bell pepper', quantity: '1', unit: 'medium', notes: 'sliced' },
      ...
      { item: 'cooked jasmine rice', quantity: '4', unit: 'cups', notes: 'for serving' }
    ]),
    instructions_json: JSON.stringify([
      'Whisk together the soy sauce, rice vinegar, brown sugar, and cornstarch in a small bowl until smooth so the sauce is ready before you start stir-frying.',
      'Heat 1 tablespoon sesame oil in a wok or large skillet over high heat until shimmering. Add the shrimp in a single layer and cook 1 to 2 minutes per side until pink and just curled, then transfer to a plate.',
      'Add the remaining sesame oil, bell peppers, and snap peas to the hot pan. Stir-fry 3 to 4 minutes until the vegetables are bright and crisp-tender.',
      'Stir in the garlic and ginger and cook 30 seconds until fragrant, scraping up any browned bits from the bottom of the pan.',
      'Return the shrimp to the pan, pour in the sauce, and toss 1 to 2 minutes until the sauce thickens and lightly coats the vegetables and shrimp.',
      'Serve the stir-fry hot over jasmine rice while the vegetables still have bite.'
    ]),
