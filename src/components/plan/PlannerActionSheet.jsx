export function PlannerActionSheet({ title, subtitle, actions = [], isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40" onClick={onClose}>
      <div className="absolute inset-x-4 bottom-4 mx-auto w-auto max-w-sm rounded-3xl bg-white p-5 shadow-2xl sm:left-1/2 sm:right-auto sm:w-[calc(100%-2rem)] sm:-translate-x-1/2" onClick={(e) => e.stopPropagation()}>
